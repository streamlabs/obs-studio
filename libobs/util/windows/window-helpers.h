...
enum window_match_type { WINDOW_MATCH_CAPTURE = 0x10, WINDOW_MATCH_IGNORE = 0x20 };
...
typedef DARRAY(struct game_capture_matching_rule) game_capture_matching_rule_array_t;
...
EXPORT struct game_capture_matching_rule convert_to_matching_rule(const char *exe, const char *rule_class,
...
EXPORT HWND find_matching_window(enum window_search_mode mode, game_capture_matching_rule_array_t *matching_rules,
...
extern int find_matching_rule_for_window(HWND window, game_capture_matching_rule_array_t *matching_rules,
