...
:checkDLL
	...
	reg query "HKLM\SOFTWARE\Classes\CLSID\{27B05C2D-93DC-474A-A5DA-9BBA34CB2A9C}" >nul 2>&1 /reg:32
	if %errorLevel% == 0 (
...
:CheckDLLContinue
	...
	reg query "HKLM\SOFTWARE\Classes\CLSID\{27B05C2D-93DC-474A-A5DA-9BBA34CB2A9C}" >nul 2>&1 /reg:64
	if %errorLevel% == 0 (
